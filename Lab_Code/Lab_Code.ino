#include <PID_v1.h>
//const int photores = A0; // Photo resistor input*****UNCOMMENT THIS LINE FOR ACTUAL CONTROL SYSTEM!!!*****
double photores = 500; //*****This line only exists for troubleshooting*****
//const int pot = A1; // Potentiometer input
double pot = 10; //constant value set for "pot", or setpoint value
...
PID myPID(&Input, &Output, &Setpoint, Kp, Ki, Kd, DIRECT); // This sets up our PID Loop (Can change REVERSE to DIRECT to change the direction of the PID compensation. i.e., if it doesnt work, change to DIRECT)
//Input is our PV
//Output is our u(t)
//Setpoint is our SP
...
//lightLevel = analogRead(photores); //Read in light level *****UNCOMMENT THIS LINE FOR ACTUAL CONTROL SYSTEM!!!*****
  lightLevel = photores; //*****This line only exists for troubleshooting*****
  ...
  Setpoint = map(pot, 0, 1024, 0, 255); //getting setpoint value from predefined desired value
